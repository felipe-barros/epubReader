            ...
            <View style={style.footer}>
                ...
                </TouchableOpacity>
                {
                    !totalPages ? (
                        ...
                        <>
                            <TouchableOpacity activeOpacity={0.8} onPress={() => setIsSearchingPage(!isSearchingPage)} style={{ position: 'absolute', left: 120, right: 100, backgroundColor: 'red', padding: 10 }} >
                                <Text style={[style.footerText, fontStyle]}>{progress} de {totalPages}</Text>
                            </TouchableOpacity>
                            {isSearchingPage && <View style={{ width: '100%', position: 'absolute', top: -40, left: 0, right: 0, alignItems: 'center' }}>
