                    ...
                    <View style={[style.resultsContainer, { backgroundColor: isDarkMode ? '#666' : '#FFF' }]}>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'center', alignItems: 'center' }}>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(1)} >
                                    <View style={{ width: 30, height: 30, borderRadius: 15, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>25%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(2)} >
                                    <View style={{ width: 35, height: 35, borderRadius: 20, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>50%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(1)} >
                                    <View style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>75%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(2)} >
                                    <View style={{ width: 45, height: 45, borderRadius: 25, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>100%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(2)} >
                                    <View style={{ width: 50, height: 50, borderRadius: 30, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>125%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 50 }} onPress={() => goDarkMode(2)} >
                                    <View style={{ width: 55, height: 55, borderRadius: 35, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                ...
                                <TouchableOpacity onPress={() => goDarkMode(2)} >
                                    <View style={{ width: 60, height: 60, borderRadius: 35, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
