    ...
    return (
        <SafeAreaView style={[style.container, themeStyle]}>
            ...
            <Modal
                ...
                <View style={style.modalContainer}>
                    <View style={[style.resultsContainer, { backgroundColor: isDarkMode ? '#666' : '#FFF' }]}>
                        <TouchableOpacity onPress={() => setIsModalVisibleNote(false)} style={{ padding: 10, alignSelf: 'flex-end' }}>
                        ...
                        <TextInput placeholder="Adicionar nota à marcação" autoFocus={true} multiline={true} textAlignVertical='top' numberOfLines={3} returnKeyType='done' />
                    </View>
                </View>
            </Modal>
        </SafeAreaView>
