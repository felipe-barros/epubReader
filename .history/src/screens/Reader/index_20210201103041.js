                ...
                </TouchableOpacity>
                {
                    !totalPages ? (
                        ...
                        <>
                            ...
                            {isSearchingPage && <View style={{ position: 'absolute', top: -60, left: 80, right: 80, alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)', borderRadius: 10, padding: 5 }}>
                                <Text style={[style.footerText, fontStyle, { color: '#FFF', fontWeight: '500' }]}>Página {searchPage}</Text>
                                <Slider
                                    minimumValue={1}
