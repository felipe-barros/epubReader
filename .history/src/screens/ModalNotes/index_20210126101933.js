...
function ModalNotes({ notes, toggleModal, isModalVisible, isDarkMode }) {
    ...
    function renderNote({ item }) {
        ...
        return (
            <View>
                <View style={{ paddingVertical: 10, paddingLeft: 10, borderLeftWidth: 4, borderLeftColor: item.color, backgroundColor: 'lightgray' }}>
                    <Text numberOfLines={2} ellipsizeMode='tail' style={{ fontSize: 16 }}>{item.text}</Text>
