...
function Home() {
    ...
    function changeFontSize(index) {
        console.log(fontSizes[index])
        var newTheme = theme;
        newTheme.size = fontSizes[index];
        setTheme(newTheme);
        refresh();
    }
                    ...
                    <View style={[style.resultsContainer, { backgroundColor: isDarkMode ? '#666' : '#FFF' }]}>
                        ...
                        <View style={{ marginTop: 40 }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'center', alignItems: 'center' }}>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(0)} >
                                    <View style={{ marginBottom: 10, width: 30, height: 30, borderRadius: 15, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>25%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(1)} >
                                    <View style={{ marginBottom: 10, width: 35, height: 35, borderRadius: 20, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>50%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(2)} >
                                    <View style={{ marginBottom: 10, width: 40, height: 40, borderRadius: 20, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>75%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(3)} >
                                    <View style={{ marginBottom: 10, width: 45, height: 45, borderRadius: 25, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>100%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(4)} >
                                    <View style={{ marginBottom: 10, width: 50, height: 50, borderRadius: 30, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>125%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(5)} >
                                    <View style={{ marginBottom: 10, width: 55, height: 55, borderRadius: 35, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>150%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(6)} >
                                    <View style={{ marginBottom: 10, width: 55, height: 55, borderRadius: 35, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>175%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => changeFontSize(7)} >
                                    <View style={{ marginBottom: 10, width: 60, height: 60, borderRadius: 35, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>200%</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
