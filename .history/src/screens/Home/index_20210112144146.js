                ...
                <View style={style.modalContainer}>
                    <View style={style.resultsContainer}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <TextInput placeholder='Buscar palavra' onChangeText={(text) => onChangeSearch(text)} style={{ padding: 10, borderRadius: 5, backgroundColor: 'lightgray', width: '85%' }} placeholderTextColor='#000' />
