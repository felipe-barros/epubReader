                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(1)} >
                                    <View style={{ marginBottom: 10, width: 35, height: 35, borderRadius: 20, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                ...
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(3)} >
                                    <View style={{ marginBottom: 10, width: 45, height: 45, borderRadius: 25, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>100%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(4)} >
                                    <View style={{ marginBottom: 10, width: 50, height: 50, borderRadius: 30, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={[{ fontSize: 18, textAlign: 'center' }, fontStyle]}>125%</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ marginRight: 40 }} onPress={() => changeFontSize(5)} >
                                    <View style={{ marginBottom: 10, width: 55, height: 55, borderRadius: 35, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                ...
                                <TouchableOpacity onPress={() => changeFontSize(7)} >
                                    <View style={{ marginBottom: 10, width: 60, height: 60, borderRadius: 35, backgroundColor: '#444', borderColor: 'lightgray', borderWidth: 1 }}></View>
