            ...
            <View style={style.footer}>
                ...
                </TouchableOpacity>
                {
                    !totalPages ? (
                        ...
                        <>
                            <TouchableOpacity activeOpacity={0.8} onPress={() => setIsSearchingPage(!isSearchingPage)} style={{ position: 'absolute', left: 120, right: 120, backgroundColor: 'red', padding: 10 }} >
