...
function Home() {
    ...
    let injectedJS = `window.BOOK_PATH = "../../../../../src/books/book2.epub"; window.LOCATIONS = ${locations}; window.THEME = ${JSON.stringify(themeToStyles(theme))};`;
    if (cl) {
    ...
    function handleMessage(msg) {
        ...
        switch (type) {
            ...
            case 'locations':
                ...
                return;
            case 'teste':
                console.log("Teste", parsedData.teste)
            default:
                return;
        }
    }
