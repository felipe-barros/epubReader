...
function Home() {
    ...
    function goHightLight() {
        console.log("Hightlight")
        webview.current?.injectJavaScript(`
        var displayHtml = $("#viewer>div>iframe").contents().find("body").html();
        displayHtml = displayHtml.replace("having", "" + "having" + "");
        $("#viewer>div>iframe").contents().find("body").html(displayHtml); true
        `);
    }
    ...
    return (
        <SafeAreaView style={style.container}>
            ...
            <View style={style.footer2}>
                <View></View>
                <Button title='Hightlight' color='#FFF' onPress={goHightLight} disabled={search.length > 0 ? false : true} />
                <View></View>
            </View>
            <View style={style.footer2}>
