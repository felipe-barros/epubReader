...
function Home() {
    ...
    let injectedJS = `window.BOOK_PATH = "../../../../../../src/books/book.epub"; window.LOCATIONS = ${locations}; window.THEME = ${JSON.stringify(themeToStyles(theme))};`;
    if (cl) {
    ...
    return (
        <SafeAreaView style={style.container}>
            <View style={style.content}>
                ...
                <WebView
                    ref={webview}
                    source={require('../../templates/index.html')}
                    originWhitelist={["*"]}
