    ...
    return (
        <SafeAreaView style={[style.container, themeStyle]}>
            ...
            <Modal
                ...
                <View style={style.modalContainer}>
                    <View style={[style.resultsContainer, { backgroundColor: isDarkMode ? '#666' : '#FFF' }]}>
                        {currentNote && <Text style={{ fontSize: 18, padding: 20, backgroundColor: '#e0e0e0', borderLeftWidth: 3, borderLeftColor: 'dodgerblue', marginBottom: 10 }} numberOfLines={3} ellipsizeMode='tail'>{currentNote.text}</Text>}
