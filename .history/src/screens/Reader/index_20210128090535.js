...
function Reader({ navigation, route }) {
    ...
    function goToNote(cfi, page = false) {
        webview.current?.injectJavaScript(`
    ...
    function handleMessage(msg) {
        ...
        switch (type) {
            ...
            case 'highlightClicked':
                ...
                return;
            case 'isLoading':
                console.log(parsedData.isLoading)
    ...
    return (
        <SafeAreaView style={[style.container, themeStyle]}>
            ...
            {
                isLoading && (
                    <View style={{ flex: 1, position: 'absolute', width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center' }}>
                        <ActivityIndicator color="#FFF" />
                        <Text style={{ color: '#FFF', fontWeight: '500', textAlign: 'center' }}>Carregando...</Text>
                    </View>
                )
            }
            <Modal
