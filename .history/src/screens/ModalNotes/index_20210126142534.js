                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1.5, backgroundColor: isDarkMode ? '#666' : '#FFF' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                            <TouchableOpacity>
                                <Text style={{ fontSize: 18, paddingTop: 20, paddingBottom: 10, textAlign: 'center', borderBottomWidth: isSelected ? 4 : 0, borderBottomColor: 'dodgerblue', color: 'gray' }}>Anotações</Text>
                            </TouchableOpacity>
                            <TouchableOpacity>
                                <Text style={{ fontSize: 18, padding: 20, textAlign: 'center', borderBottomWidth: !isSelected ? 4 : 0, borderBottomColor: 'dodgerblue' }}>Páginas Salvas</Text>
                            </TouchableOpacity>
                        </View>
