                ...
                <View style={style.modalContainer}>
                    <View style={style.resultsContainer}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <TextInput text={search} placeholder='Buscar palavra' onChangeText={setSearch} style={{ padding: 10, borderRadius: 5, backgroundColor: 'lightgray', width: '65%' }} placeholderTextColor='#000' />
