...
import { Button, Modal, SafeAreaView, Text, TextInput, TouchableOpacity, View } from 'react-native';
        ...
        <SafeAreaView style={style.container}>
            ...
            <Modal
                ...
                <View style={style.modalContainer}>
                    <View style={style.resultsContainer}>
                        <View style={style.resultHeader}>
                            <TextInput placeholder='Buscar palavra' onChangeText={() => onChangeSearch(text)} />
