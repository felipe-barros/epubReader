            ...
            <Modal
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1.5, backgroundColor: isDarkMode ? '#666' : '#FFF' }}>
                        <Tab.Navigator>
                            <Tab.Screen name="Notes" component={() => <ModalNotes notes={notes} toggleModal={toggleModal} isModalVisible={isModalVisible} isDarkMode={isDarkMode} goToNote={goToNote} />} options={{ title: "Anotações" }} />
