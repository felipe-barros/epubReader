        ...
        <SafeAreaView style={style.container}>
            <View style={style.content}>
                <View style={style.header}>
                    ...
                    <Text style={{ color: '#FFF', fontSize: 20, fontWeight: '500' }}>Knight Without Armour</Text>
                    <TouchableOpacity style={{ padding: 10 }}>
            ...
            <View style={style.footer}>
                ...
                <Text style={[style.footerText, { position: 'absolute', left: 0, right: 0 }]}>{progress} de {totalPages}</Text>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity onPress={() => setisModalVisibleSearch(true)} style={{ padding: 10, marginRight: 20 }}>
                        <Icon name="search-outline" size={30} color="#FFF" style={style.iconMargin} />
                    </TouchableOpacity>
