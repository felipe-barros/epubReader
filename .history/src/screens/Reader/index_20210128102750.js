...
function Reader({ navigation, route }) {
    ...
    let injectedJS = `window.BOOK_PATH = "${path}";
    ...
    function handleMessage(msg) {
        ...
        switch (type) {
            ...
            case 'isLoading':
                setIsLoading(parsedData.isLoading);
            case 'teste1':
                console.log("Teste1:", parsedData.teste);
            case 'teste2':
                console.log("Teste2:", parsedData.teste);
            default:
                return;
        }
    }
    ...
    return (
        <SafeAreaView style={[style.container, themeStyle]}>
            ...
            <View style={style.footer}>
                ...
                {
                    !totalPages ? (
                        <View style={{ position: 'absolute', left: 100, right: 100 }}>
