                ...
                <View style={style.header}>
                    ...
                    <View style={style.headerContent}>
                        <View style={style.headerSide}>
                            ...
                            <Icon name="list-outline" size={25} color="#FFF" style={style.iconMargin} />
                        </View>
                        <View style={style.headerSide}>
                            <Icon name="text-outline" size={25} color="#FFF" />
                            <Icon name="search-outline" size={25} color="#FFF" style={style.iconMargin} />
                            <Icon name="bookmark-outline" size={25} color="#FFF" style={style.iconMargin} />
                        </View>
                    </View>
                </View>
                <WebView
