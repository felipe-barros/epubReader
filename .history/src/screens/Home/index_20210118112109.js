...
function Home() {
    ...
    let injectedJS = `window.BOOK_PATH = "https://cevativo-hosting-mobilehub-306309057.s3-sa-east-1.amazonaws.com/3o_ano_-_Biologia_A_-_Livro_1_-_refluivel.epub'"; window.THEME = ${JSON.stringify(themeToStyles(theme))};`;
    if (cl) {
