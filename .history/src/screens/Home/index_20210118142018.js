                    ...
                    <View style={style.resultsContainer}>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <View>
                                    <View style={{ width: 100, height: 100, borderRadius: 50, marginRight: 40, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={{ fontSize: 18 }}>Padrão</Text>
                                </View>
                                <View>
