        ...
        <SafeAreaView style={[style.container, themeStyle]}>
            ...
            <Modal
                ...
                <View style={[style.modalContainer]}>
                    <View style={[style.resultsContainer, { backgroundColor: isDarkMode ? '#AAA' : '#FFF' }]}>
                        <View style={style.resultHeader}>
                            <View></View>
                            <Text style={[style.resultTitle, { position: 'absolute', left: 0, right: 0, textAlign: 'center' }]}>Configurações de Leitura</Text>
                            <Button title="Voltar" onPress={() => setisModalVisibleFont(false)} />
                        </View>
                        <View style={{ marginTop: 20 }}>
                            <Text style={{ fontSize: 18, textAlign: 'center' }}>Tema de Leitura</Text>
                            <View style={{ flexDirection: 'row', marginTop: 20, justifyContent: 'center' }}>
                                ...
                                <TouchableOpacity onPress={() => goDarkMode(2)} >
                                    ...
                                    <Text style={{ fontSize: 18, textAlign: 'center' }}>Escuro</Text>
                                </TouchableOpacity>
                            </View>
