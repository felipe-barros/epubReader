...
function Reader({ navigation, route }) {
    ...
    function handleMessage(msg) {
        ...
        switch (type) {
            ...
            case 'loc':
                if (locations) {
                    console.log("Total de páginas:", JSON.parse(locations).length)
                    console.log("Configuração atual:", parsedData.teste)
                    console.log("Página atual:", JSON.parse(locations)[20])
                }
