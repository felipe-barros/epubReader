        ...
        <SafeAreaView style={[style.container]}>
            <Modal
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1.5, backgroundColor: isDarkMode ? '#666' : '#FFF', paddingTop: 10 }}>
                        <Tab.Navigator>
                            <Tab.Screen
                                name="Notes"
                                options={{ title: "Anotações" }}
                                component={() => <ModalNotes notes={notes} toggleModal={toggleModal} isModalVisible={isModalVisible} isDarkMode={isDarkMode} goToNote={goToNote} />}
                            />
                            <Tab.Screen
                                name="Notes1"
                                options={{ title: "Páginas Salvas" }}
                                component={ModalNotes}
                            />
                        </Tab.Navigator>
                    </View>
                </View>
