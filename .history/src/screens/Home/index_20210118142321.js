                    ...
                    <View style={style.resultsContainer}>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 20 }}>
                                <View>
                                    <View style={{ alignSelf: 'center', width: 100, height: 100, borderRadius: 50, marginRight: 50, backgroundColor: '#fafafa', borderColor: 'lightgray', borderWidth: 1 }}></View>
                                    <Text style={{ fontSize: 18, textAlign: 'center', backgroundColor: 'red' }}>Padrão</Text>
                                </View>
                                <View>
