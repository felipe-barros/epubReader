                ...
                <View style={style.modalContainer}>
                    <View style={style.resultsContainer}>
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                            <TextInput placeholder='Buscar palavra' onChangeText={(text) => onChangeSearch(text)} style={{ padding: 10, borderRadius: 5, backgroundColor: 'lightgray', width: '50%' }} placeholderTextColor='#000' />
                            <Button title="Voltar" onPress={() => setisModalVisibleSearch(false)} style={{ width: '100%' }} />
                            <Button title="Voltar" onPress={goSearch} style={{ width: '100%' }} />
                        </View>
                        {
